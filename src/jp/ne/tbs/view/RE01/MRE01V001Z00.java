...
//	String[] comb_8_2 = { "", "有り", "無し" };
	...
	public MRE01V001Z00() {
		...
		label_1.setPreferredSize(LAYOUT_10BY2);
		label_1.setHorizontalAlignment(JLabel.CENTER);
		this.addComp(label_1, 0, 0, 11, 1);

		//２行目(改行のための空白文字)
		JLabel label_2 = new JLabel("　");
		label_2.setFont(new Font("メイリオ", Font.PLAIN, 15));
		this.addComp(label_2, 0, 1, 11, 1);
		...
		label_3_1.setPreferredSize(LAYOUT_1BY1);
		label_3_1.setHorizontalAlignment(JLabel.RIGHT);
		this.addComp(label_3_1, 1, 2, 1, 1);

		//受付日　テキスト
		DatePicker datePicker1 = new DatePicker();
		datePicker1.setDateToToday();
		datePicker1.setFont(new Font("メイリオ", Font.PLAIN, 17));
		datePicker1.setPreferredSize(LAYOUT_1BY1);
		this.addComp(datePicker1, 2, 2, 1, 1);
...
//		label_5_1.setPreferredSize(LAYOUT_1BY1);
//		label_5_1.setHorizontalAlignment(JLabel.LEFT);
//		this.addComp(label_5_1, 0, LOW_PAT_INF, 1, 1);
//
//		//フリガナ ラベル
...
//		label_6_3.setPreferredSize(LAYOUT_1BY1);
//		label_6_3.setHorizontalAlignment(JLabel.RIGHT);
//		this.addComp(label_6_3, 3, LOW_PAT_INF + 1, 1, 1);
//
...
//		combo_6_4.addActionListener(this);
//		combo_6_4.setActionCommand("sex");
//		this.addComp(combo_6_4, 4, LOW_PAT_INF + 1, 1, 1);
//
...
//		label_6_5.setPreferredSize(LAYOUT_1BY1);
//		label_6_5.setHorizontalAlignment(JLabel.RIGHT);
//		this.addComp(label_6_5, 5, LOW_PAT_INF + 1, 1, 1);
//
//		//生年月日 テキスト
...
//		text_8_4.setPreferredSize(LAYOUT_1BY1);
//		this.addComp(text_8_4, 4, LOW_PAT_INF + 3, 1, 1);
//
//		//携帯番号 ラベル
//		JLabel label_8_5 = new JLabel("携帯番号");
//		label_8_5.setFont(new Font("メイリオ", Font.PLAIN, 22));
//		label_8_5.setPreferredSize(LAYOUT_1BY1);
//		label_8_5.setHorizontalAlignment(JLabel.RIGHT);
//		this.addComp(label_8_5, 5, LOW_PAT_INF + 3, 1, 1);
//
//		//携帯番号　テキスト
...
//		text_8_6.setPreferredSize(LAYOUT_1BY1);
//		this.addComp(text_8_6, 6, LOW_PAT_INF + 3, 1, 1);
//
//		//９行目(改行のための空白文字)
//		JLabel label_9 = new JLabel("　");
//		label_9.setFont(new Font("メイリオ", Font.PLAIN, 10));
//		this.addComp(label_9, 0, LOW_PAT_INF + 4, 11, 1);
