 ...
 * <p>[概要]</p>
 * <p>[変更履歴]</p>
 * 　　2020/08/13　小嶋純史　新規作成
 */
public class MRE01B001Z00 extends MAA00B001Z00 {
	...
	public void doTrxChk(MAA00B002Z00 allInOneData) {
		...
		//TRXチェックを実行
		MAA00B004Z00 trxChkObj = new MRE01B002Z00();
	...
	public void doMstChk(MAA00B002Z00 allInOneData) {
		...
		//マスターチェックを実行
		MAA00B005Z00 trxChkObj = new MRE01B003Z00();
		trxChkObj.setAllInOneData(allInOneData);
		trxChkObj.execute();
	...
	public void doBizCtl(MAA00B002Z00 allInOneData) throws Exception {
		...
		//業務コントロールを実行
		MAA00B006Z00 trxChkObj = new MRE01B004Z00();
		trxChkObj.setAllInOneData(allInOneData);
		trxChkObj.execute();
	...
	/**
	 * <p>[概 要] 画面編集コントロール実行</p>
	 * <p>[詳 細] 画面編集コントロールを実装する。</p>
	 * <p>[備 考] </p>
	 * @param allInOneData セットする
	 */
	public void doEdtCtl(MAA00B002Z00 allInOneData) {
		...
		//帳票編集コントロールを実行
		MAA00B007Z00 trxChkObj = new MRE01B005Z00();
		trxChkObj.setAllInOneData(allInOneData);
		trxChkObj.execute();
