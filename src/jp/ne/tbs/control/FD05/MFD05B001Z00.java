...
/**
 * <p>[クラス名]</p>
 * 　　新型コロナワクチン接種希望集計(往診列毎)　業務メイン
 * <p>[概要]</p>
 * <p>[変更履歴]</p>
 * 　　2021/03/15　小嶋純史　新規作成
 */
public class MFD05B001Z00 extends MAA00B001Z00 {
	...
	public void doTrxChk(MAA00B002Z00 allInOneData) {
		...
		//TRXチェックを実行
		MAA00B004Z00 trxChkObj = new MFD05B002Z00();
	...
	public void doMstChk(MAA00B002Z00 allInOneData) {
		...
		//マスターチェックを実行
		MAA00B005Z00 trxChkObj = new MFD05B003Z00();
		trxChkObj.setAllInOneData(allInOneData);
		trxChkObj.execute();
	...
	public void doBizCtl(MAA00B002Z00 allInOneData) throws Exception {
		...
		//業務コントロールを実行
		MAA00B006Z00 trxChkObj = new MFD05B004Z00();
		trxChkObj.setAllInOneData(allInOneData);
		trxChkObj.execute();
	...
	public void doEdtCtl(MAA00B002Z00 allInOneData) {
		...
		//帳票編集コントロールを実行
		MAA00B007Z00 trxChkObj = new MFD05B005Z00();
		trxChkObj.setAllInOneData(allInOneData);
		trxChkObj.execute();
